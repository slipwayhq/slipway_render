...
pub struct ActionOpenUrl {
    ...
    #[serde(deserialize_with = "deserialize_action_or_fallback_option")]
...
pub struct InputChoiceSet {
    ...
    #[serde(rename = "fallback")]
    #[serde(deserialize_with = "deserialize_element_or_fallback_option")]
...
pub struct Column {
    ...
    pub background_image: Option<BackgroundImage>,
    #[serde(rename = "fallback")]
    #[serde(deserialize_with = "deserialize_column_or_fallback_option")]
...
pub struct Image {
    ...
    #[serde(rename = "height")]
    #[serde(deserialize_with = "deserialize_string_or_block_element_height")]
